...
<HTML>
<HEAD>
<TITLE>VIEW ORDERS |ADMIN | ASE EATS</TITLE>
<style type="text/css">
...
$query = "SELECT * FROM `orders` WHERE `order_status`='Cooking';";
...
if ($result = $mysqli->query($query)) {
    ...
    {     
        ...
        echo '<tr> 
                  <td><font face="Verdana"><a href="est.php?id='.$field1name.'">'.$field1name.'</a></font></td> 
...
<a><b>Click on ID to see ordered items!</b><a>
</div>	  
</BODY>
</HTML>
