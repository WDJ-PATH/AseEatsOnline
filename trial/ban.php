...
<HTML>
<HEAD>
<TITLE>BAN USER |ADMIN | ASE EATS</TITLE>
<style type="text/css">
...
echo '</br>
      ...
      <font size="6" face="Courier New" color="black">BAN USERS</font>
      </br>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
  {
	$email=$_POST['field1'];
	$ban=$_POST['field2'];
	$sql = "UPDATE `php_users_login` SET `acc_status`='$ban' WHERE `email`='$email';";
    if(mysqli_query($mysqli, $sql))
	{
		if($ban==0){
		$message = 'Email :'.$_POST['field1'].' is banned for a while!';
		}
		else{
			$message = 'Email :'.$_POST['field1'].' is unbanned';
		}
	}
	else
	{  
		$message = "Could not ban. Check if email entered is correct!"; 
	}
...
<div class="form-style-5" >
          ...
          <legend><span class="number"></span> Ban Status</legend>
