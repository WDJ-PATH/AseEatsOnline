...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $res = $mysqli->query($sq);
    $ss = $res->fetch_assoc();
	$message="Google payment successful! You will be notified when your order is ready!";
	echo "<script type='text/javascript'>alert('$message');</script>";
	$URL='/../bill.php?id='.$ss['id'];
...
alert('You have selected COD option! You will be notified when the order is ready!');
var myvar= '<?php echo $_SESSION['getid']+1?>';
window.location.href = '/../bill.php?id='+myvar;
}
</script>
...
<div class="card">
	...
	<ul>
		<li>
			...
			<form class="reveal-if-active" method="POST" action="4d-thank-you.php" onsubmit="return validate()">
		...
		<li>
			...
			<input type="submit" align="center" onclick="return valid()" class="button" data-loading-text="Payment Processing.." value="Checkout!">
			</div>
		</li>
	</ul>
</div>
